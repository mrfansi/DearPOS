...
// in app/test/features/product_management/data/datasources/product_remote_data_source_test.dart.
...
class GeneratedMockCollectionReference extends _i1.Mock
    implements _i4.CollectionReference<Map<String, dynamic>> {
  GeneratedMockCollectionReference() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class GeneratedMockQuerySnapshot extends _i1.Mock
    implements _i4.QuerySnapshot<Map<String, dynamic>> {
  GeneratedMockQuerySnapshot() {
    _i1.throwOnMissingStub(this);
  }
